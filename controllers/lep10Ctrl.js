...
angular.module("hmisPortal")
    ...
    .controller("lep10Ctrl",function ($rootScope,$scope,$http,$location,$timeout,olData,olHelpers,shared) {
        $scope.lastCard = function () {
            ...
            $.post(base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if ($scope.selectedOrgUnit == "m0frOspS7JY") {
                    $scope.url="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:EEbmnNXxOHC;gBhKfIx1Q4q;RS3Eto0wtMa;pDqs91c1ViU;bz7oUGEAWiM;OGp8yfII3Le;a4qM75GFfe8;hPCQrTBwX4f;Kb41DrHLudN;FkaL7C5dTQf;fUYwyqun0tB;rooLcyc0sTo;E4CDCutdF5s;ABiM2ygMnVe;kap2LM7rSsq;JF7YZlSbaQ4;nQuaVmLTp0n;OsvfJFAOspq&dimension=ou:LEVEL-2;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                } else {
                    $scope.url="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:EEbmnNXxOHC;gBhKfIx1Q4q;RS3Eto0wtMa;pDqs91c1ViU;bz7oUGEAWiM;OGp8yfII3Le;a4qM75GFfe8;hPCQrTBwX4f;Kb41DrHLudN;FkaL7C5dTQf;fUYwyqun0tB;rooLcyc0sTo;E4CDCutdF5s;ABiM2ygMnVe;kap2LM7rSsq;JF7YZlSbaQ4;nQuaVmLTp0n;OsvfJFAOspq&dimension=ou:LEVEL-3;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                }
        ...
        $scope.downloadExcelTotal = function(){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
                    var lastUrl="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:EEbmnNXxOHC;gBhKfIx1Q4q;RS3Eto0wtMa;pDqs91c1ViU;bz7oUGEAWiM;OGp8yfII3Le;a4qM75GFfe8;hPCQrTBwX4f;Kb41DrHLudN;FkaL7C5dTQf;fUYwyqun0tB;rooLcyc0sTo;E4CDCutdF5s;ABiM2ygMnVe;kap2LM7rSsq;JF7YZlSbaQ4;nQuaVmLTp0n;OsvfJFAOspq&dimension=ou:LEVEL-2;m0frOspS7JY&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&tableLayout=true&columns=dx&rows=ou";
                    ...
                    var lastUrl="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:EEbmnNXxOHC;gBhKfIx1Q4q;RS3Eto0wtMa;pDqs91c1ViU;bz7oUGEAWiM;OGp8yfII3Le;a4qM75GFfe8;hPCQrTBwX4f;Kb41DrHLudN;FkaL7C5dTQf;fUYwyqun0tB;rooLcyc0sTo;E4CDCutdF5s;ABiM2ygMnVe;kap2LM7rSsq;JF7YZlSbaQ4;nQuaVmLTp0n;OsvfJFAOspq&dimension=ou:LEVEL-3;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&tableLayout=true&columns=dx&rows=ou"
