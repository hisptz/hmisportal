...
angular.module("hmisPortal")
    ...
    .controller("lep07Ctrl",function ($rootScope,$scope,$http,$location,$timeout,olData,olHelpers,shared) {
        $scope.lastCard = function () {
            ...
            $.post(base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if ($scope.selectedOrgUnit == "m0frOspS7JY") {
                    $scope.url="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:qTwE50oi6Jp;cjEfpTFPQrW;D3sSeZPbnfQ;gFQSG3On0hD;kPtngJnTBy4;Fj4S9nyaPh1;F06E9TAWg6k;zBaaJirQPJV;PXimZ8NMjSj;bhjD9pFH9tG;LOpi3HaqLY9;oXfDfX39cw0;f9BiR6p0Vxm;dxLwVxaylW3;NzvIQSm9j1f;g3O0BKpxDoG;tt9fvIk4iAP;mlPxJuYmnCV;fikz0CmSfzr;aq8IGy99UeD;PciOe3HVu9m&dimension=ou:LEVEL-2;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                } else {
                    $scope.url="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:qTwE50oi6Jp;cjEfpTFPQrW;D3sSeZPbnfQ;gFQSG3On0hD;kPtngJnTBy4;Fj4S9nyaPh1;F06E9TAWg6k;zBaaJirQPJV;PXimZ8NMjSj;bhjD9pFH9tG;LOpi3HaqLY9;oXfDfX39cw0;f9BiR6p0Vxm;dxLwVxaylW3;NzvIQSm9j1f;g3O0BKpxDoG;tt9fvIk4iAP;mlPxJuYmnCV;fikz0CmSfzr;aq8IGy99UeD;PciOe3HVu9m&dimension=ou:LEVEL-3;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                }
        ...
        $scope.downloadExcelTotal = function(){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
                    ...
                    var lastUrl="http://139.162.204.124/dhis/api/analytics.json?dimension=dx:qTwE50oi6Jp;cjEfpTFPQrW;D3sSeZPbnfQ;gFQSG3On0hD;kPtngJnTBy4;Fj4S9nyaPh1;F06E9TAWg6k;zBaaJirQPJV;PXimZ8NMjSj;bhjD9pFH9tG;LOpi3HaqLY9;oXfDfX39cw0;f9BiR6p0Vxm;dxLwVxaylW3;NzvIQSm9j1f;g3O0BKpxDoG;tt9fvIk4iAP;mlPxJuYmnCV;fikz0CmSfzr;aq8IGy99UeD;PciOe3HVu9m&dimension=ou:LEVEL-3;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&tableLayout=true&columns=dx&rows=ou"
