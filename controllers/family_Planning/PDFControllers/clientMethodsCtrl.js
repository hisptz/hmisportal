...
angular.module("hmisPortal")
    ...
    .controller("clientMethodsCtrl", function ($rootScope, $scope, $http, portalService, FPManager, $timeout) {
...
//            $('#orgunitss option[value="m0frOspS7JY"]').prop('selected', true);
        ...
        $scope.fpCards = [
            ...
            {
                title: 'National number of FP clients through routine facility-based service, '+FPManager.getlastTwelveMonthName(FPManager.lastMonthWithData),
        ...
        $scope.getAllMethods = function () {
            ...
            angular.forEach($scope.detailedMethod, function (value) {
                ...
                if (value.new != '') {
                    methods.push(value.new)
                }
                if (value.returning != '') {
                    methods.push(value.returning)
                }
            });
            return methods.join(";");
        };
